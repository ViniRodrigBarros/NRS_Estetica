...
insert into agendamentos ( obs, realizado, pago, preco_total, desconto, fk_cliente, fk_socio) values ('?','0',0,0,0,1,1);
insert into agendamentos (data_hora) values ( STR_TO_DATE('01/01/2000 00:00:00','%d/%m/%Y h:%i:%s')); 
insert into servicos(nome ,tempo ,obs , preco ,desconto, fk_socio1) values ('?',"00:00:00",'?',1,1,1);
